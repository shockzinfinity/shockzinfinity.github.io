...
![CQRS diagram](https://docs.microsoft.com/ko-kr/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/apply-simplified-microservice-cqrs-ddd-patterns) _간소화된 CQRS 및 DDD 패턴 적용 [MSDN]_
